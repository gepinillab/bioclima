...
levels(max_2020_01) <- data.frame(id = 1:12,
                                mes = c("Ene", "Feb", "Mar", "Abr", 
                                        "May", "Jun", "Jul", "Aug", 
                                        "Sep", "Oct", "Nov", "Dic"))
plot(max_2000_01)
```
```{r}
bio13_2020_01 <- clima(prcp = ppt[[121:360]], bios = 13)
plot(bio13_2020_01)
```
```{r}
bio13_2020_01_fix <- clima(prcp = ppt[[121:360]], bios = 13, 
                       wettest_unit = max_1990_01)
plot(bio13_2020_01_fix)
```
```{r}
